    ...
    <div>
      <div className="mens-list">
        ...
        <li>
          ...
          <Link to="/decor&accents">Decor&Accents</Link>
        </li>
        <li>
          <img src="./src/assets/mens-images/jeans.jpg" alt="image" />
          <Link to="/bedding&linens">Bedding&Linens</Link>
        </li>
        <li>
        ...
        <li>
          ...
          <Link to="/homeelectronics">Home Electronic</Link>
        </li>
        <li>
          <img src="./src/assets/mens-images/beauty.jpg" alt="image" />
          <Link to="/homefitness">Home Fitness</Link>
        </li>
      </div>
